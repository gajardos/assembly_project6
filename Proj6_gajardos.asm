...
;			   Then the sum and average is calculated with the GetAvg procedure which saves it into memory and finally the Writeval 
...
; in 32 bits for both positive a negative cases, it also validates it's a number vs another character or letter. When the input is 
...
; dividing SDWORD input by 10, appending remainder to passed string address and continuing until result is 0. Then null terminates the 
